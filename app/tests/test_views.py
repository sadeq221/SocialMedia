...
#     # # ====================== Test Register  =========================
    ...
    def test_invalid_register_email_exists(self):
        ...
        # Lets change set an email that already exists in the database
    ...
    def test_invalid_token_refresh_invalid_or_expired_token(self):
        ...
        response = self.client.post(self.token_refresh_url, data={"refresh": "ufhdfkfjdfj"})
...
class TestProfileViews(TestCase):
    ...
    def test_valid_edit_profile(self):
        ...
        # Reassign self.profile in order to get a new version of it containing the avatar
...
# # ==================== Create post =======================
    ...
    def test_valid_create_post_with_image(self):
        ...
        uploaded_file = SimpleUploadedFile(name="image.jpg", content=image.read(), content_type="image/jpeg")
        ...
        self.assertEqual(
            response.json(),
            {
                ...
                "data": {
                    ...
                    "created": post.created.strftime("%Y-%m-%dT%H:%M:%S.%fZ"),
                    "last_edited": post.last_edited.strftime("%Y-%m-%dT%H:%M:%S.%fZ"),
                    # User of the post is not changed
                    "user": post.user.id
                }
            }
        )
    ...
    def test_invalid_delete_post_not_own_the_post(self):
        ...
        # Right response message
        self.assertEqual(response.json(), {"message": "You can't delete other's posts."})
...
#     # ====================== like a Post ==============================
    ...
    def test_valid_like_post(self):
        ...
        self.assertEqual(
            response.json(),
            {
                ...
                "total_likes": len(self.user.post_likes.all())
            }
        )
    ...
    def test_invalid_list_user_post_likes_no_post_likes(self):
        ...
        self.assertEqual(
            response.json(),
            {
                "message": "No post_likes for this User."
            }
        )
...
class TestCommentViews(TestCase):
        ...
        self.assertEqual(
            response.json(),
            {
                ...
                "data": {
                    ...
                    "content": self.comment.content,
                    "created": self.comment.created.strftime("%Y-%m-%dT%H:%M:%S.%fZ"),
                    "last_edited": self.comment.last_edited.strftime("%Y-%m-%dT%H:%M:%S.%fZ"),
                    "user": self.comment.user.id,
                    "post": self.comment.post.id,
                    "parent": self.comment.parent
                }
    ...
    def test_invalid_edit_comment_not_own_the_comment(self):
        ...
        # Right response message
        self.assertEqual(response.json(), {"message": "You can't edit other's comments."})
    ...
    def test_invalid_delete_comment_not_own_the_comment(self):
        ...
        # Right response message
        self.assertEqual(response.json(), {"message": "You can't delete other's comments."})
    ...
    def test_invalid_list_user_comment_likes_no_comment_likes(self):
        ...
        self.assertEqual(
            response.json(),
            {
                "error": "No comment_likes for this User."
            }
        )
...
# # =================== follow =====================
    ...
    def test_valid_follow(self):
        ...
        self.assertEqual(
            response.json(),
            {
                "message": f"Successfully followed {self.following.name}"
            }
        )
